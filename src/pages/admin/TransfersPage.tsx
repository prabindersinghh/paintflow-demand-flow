...
export default function TransfersPage() {
  ...
  const noData = transfers.length === 0 && reorders.length === 0;
    ...
    <div className="space-y-6">
      ...
      {noData ? (
        <div className="rounded-lg border border-border bg-card">
          <EmptyState
            title="No planned logistics actions"
            message="Run the Planning Engine from the Overview to generate transfer and reorder recommendations."
        ...
        <>
          ...
          <div className="rounded-lg border border-border bg-card">
            ...
            {transfers.length === 0 ? (
              <div className="px-5 py-6 text-center text-xs text-muted-foreground">No transfers recommended in this plan run.</div>
            ) : (
          ...
          <div className="rounded-lg border border-border bg-card">
            ...
            {reorders.length === 0 ? (
              <div className="px-5 py-6 text-center text-xs text-muted-foreground">No reorders recommended in this plan run.</div>
            ) : (
              <div className="overflow-x-auto">
                <table className="w-full text-xs">
                  <thead>
